...
%
%% Examples
% # atom=remove_covalent_bond(atom,Box_dim,Bond_index)
% # atom=remove_covalent_bond(atom,Box_dim,Bond_index,Angle_index)
% # atom=remove_covalent_bond(atom,Box_dim,Bond_index,Angle_index,Dihedral_index)
% # atom=remove_covalent_bond(atom,Box_dim,Bond_index,Angle_index,Dihedral_index,rmaxlong)

function atom = remove_covalent_bond(atom,Box_dim,varargin)
...
atom=recalc_bond_atom(atom,Box_dim,Bond_index,Angle_index,Dihedral_index,maxrlong);
