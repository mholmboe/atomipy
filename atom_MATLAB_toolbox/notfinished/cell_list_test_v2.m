...
%
%% Examples
% # dist_matrix = cell_list_dist_matrix_atom1atom2(atom1,atom2,Box_dim) % Basic input arguments
% # dist_matrix = cell_list_dist_matrix_atom1atom2(atom1,atom2,Box_dim,1.25) % Setting the max distance for bonds with H's
% # dist_matrix = cell_list_dist_matrix_atom1atom2(atom1,atom2,Box_dim,1.25,2.25) % Setting the max distance for bonds, otherwise default is 12 Å
% # dist_matrix = cell_list_dist_matrix_atom1atom2(atom1,atom2,Box_dim,1.25,2.25,2.25) % Setting the max distance for angles, default is not to calculate any angles

function [dist_matrix,pair,dist,X_dist,Y_dist,Z_dist] = cell_list_dist_matrix_atom1atom2(atom1, atom2, Box_dim, varargin)
