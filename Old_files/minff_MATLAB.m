...
%
%% Examples
% # atom=minff_MATLAB(atom,Box_dim)
% # atom=minff_MATLAB(atom,Box_dim,'minff')
% # atom=minff_MATLAB(atom,Box_dim,'minff',heal_iterations)

function atom=minff_MATLAB(atom,Box_dim,varargin)
%%
format compact;
